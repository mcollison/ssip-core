 ...
 */
public class FilterStepDescription {
    ...
    public FilterStepDescription(int depth, boolean depthFirst) {
        this.depth = depth;
        this.depthFirst = depthFirst;
    }

    public FilterStepDescription(SSIPNode from, SSIPNode to, Set<String> type, boolean extend) {
        this.extend = extend;
        this.from = from;
        this.relType = type;
        this.to = to;
    ...
    public FilterStepDescription(SSIPNode from, SSIPNode to, Set<String> type, Dir traverseDirection, boolean extend) {
        this.extend = extend;
        this.from = from;
        this.relType = type;
        this.to = to;
    ...
    public FilterStepDescription(Set<String> type, Dir traverseDirection, boolean extend, Map<String, Object> toNodeProps, Map<String, Object> relProps) {
        this.extend = extend;
        this.relType = type;
    ...
    public FilterStepDescription(SSIPNode from, SSIPNode to, Set<String> type, Dir traverseDirection, Map<String, Object> toNodeProps, Map<String, Object> relProps) {
        this.from = from;
        this.relType = type;
        this.to = to;
        this.toNodeProperties = toNodeProps;
    ...
    public StepDescription[] getStep() {
        ...
        for (String rel : relType) {
            if (rel.equals("BINDS_TO")) {
                step[0].addRelation(StepDescription.RelTypes.BINDS_TO);
            }
            if (rel.equals("IS_ENCODED_BY")) {
                step[0].addRelation(StepDescription.RelTypes.IS_ENCODED_BY);
            }
        }
        return step;
    }
