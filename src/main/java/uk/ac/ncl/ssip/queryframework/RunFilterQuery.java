...
import uk.ac.ncl.ssip.queryframework.ComputeFilter;
import uk.ac.ncl.ssip.queryframework.FilterQueryInterface;
...
public class RunFilterQuery {
    ...
    private FilterQueryInterface query;
    ...
    public RunFilterQuery(FilterQueryInterface query, Neo4J handler) {
        this.query = query;
    ...
    public FilterQueryInterface getQuery() {
        return query;
    }
